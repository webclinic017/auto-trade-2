...
from ..entities import (
    PositionEntity, TradeEntity, OrderEntity, OrderRequest, ContractEntity, BacktestTradeEntity
)
...
class OffsetConverter:
    ...
    def update_position(self, position: PositionEntity):
        """"""
    ...
    def update_trade(self, trade: TradeEntity):
        """"""
...
class PositionHolding:
    ...
    def __init__(self, acc: str, contract: ContractEntity):
        """"""
        self.account = acc
    ...
    def update_trade(self, trade: Union[TradeEntity, BacktestTradeEntity]):
        """"""
