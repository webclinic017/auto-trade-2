...
class CtaSignal(ABC):
    ...
    @virtual
    def on_tick(self, tick: TickEntity):
        """
...
class TargetPosTemplate(CtaTemplate):
    ...
    @virtual
    def on_order(self, order: OrderEntity):
        """
