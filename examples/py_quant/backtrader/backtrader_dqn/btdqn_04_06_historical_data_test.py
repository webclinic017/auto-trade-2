...
class DQN(object):
    ...
    def __init__(self, config):
        ...
        Args:
            ...
            n_feature(LeCun et al.): the number of type of input (e.g. the number of company to use at stock trading)
            n_history(LeCun et al.): the nubmer of history that will be used as input
            n_smooth, n_down(LeCun et al.): the number of smoothed and down sampling input at CNN
    ...
    def train(self, input_data, noise_scale=0.1):
        ...
        t0 = self.n_history + self.n_batchself.initialize_memory(stock_data[:t0], scale=noise_scale)
        save_data_freq = 10
        save_weight_freq = 10
        count = 0
    ...
    def transform_input(self, input):
        ...
        Return:list of the same shape tensors, [None, self.length_history, self.n_stock]
        """
