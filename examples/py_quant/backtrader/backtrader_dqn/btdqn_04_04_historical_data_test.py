# 4.Example of analyzing stock returns (from 
# https://github.com/backtrader/backtrader/blob/master/samples/analyzer-annualreturn/analyzer-annualreturn.py
# )
...
def parse_args():
    ...
    parser.add_argument('--stake', default=1, type=int,help='Stake to apply in eachoperation')
