...
def get_realtime_data_pankou(code):
    """
    从东方财富网获取股票盘口实时数据
    :param daima: 股票代码
    :return:  盘口数据
    ...
    if code[:2] == "sh":
        ...
        lsbl = '0.' + code[2:]
    url = 'http://push2.eastmoney.com/api/qt/stock/get?&fltt=2&invt=2&fields=f120,f121,f122,f174,f175,f59,f163,f43,f57,' \
...
if __name__ == '__main__':
    while 1:
        get_realtime_data_pankou('sz000001')
        time.sleep(1)