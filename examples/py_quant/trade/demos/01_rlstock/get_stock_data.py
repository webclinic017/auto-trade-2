...
if __name__ == '__main__':
    ...
    downloader = Downloader('./tmp/data/train', date_start='1990-01-01', date_end='2019-11-29')
    downloader.run()

    mkdir('./tmp/data/test')
    downloader = Downloader('./tmp/data/test', date_start='2019-12-01', date_end='2019-12-31')
    downloader.run()