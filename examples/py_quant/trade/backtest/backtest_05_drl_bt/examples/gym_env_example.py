...
import sys,os
# ROOT_DIR = os.path.dirname(os.path.abspath(__file__))#项目根目录所在的绝对路径
# ROOT_DIR = '/Users/afirez/studio/python/auto-trade/examples/py_quant/trade/backtest/backtest_05_drl_bt'#项目根目录所在的绝对路径
ROOT_DIR = os.path.dirname(os.path.pardir)
sys.path.append(ROOT_DIR)
print(f'{sys.path}')

from strategys import returnBasedStrategy
from utils import actionObserver,rewardObserver,cummulativeRewardObserver
from engines import  BTEngine
from envs import BtGymEnvBase
